...
(
    ID              SERIAL UNIQUE,
    CAR_INDEX       BIGINT UNSIGNED UNIQUE NOT NULL,
    ...
    CONSTRAINT COMP_KEY_ID_CAR_INDEX PRIMARY KEY (ID, CAR_INDEX),
    UNIQUE INDEX IDX_CARS_CAR_ID_UNIQUE (ID ASC),
    UNIQUE INDEX IDX_CARS_CAR_INDEX_UNIQUE (CAR_INDEX ASC),
    UNIQUE INDEX IDX_CARS_BRAND (BRAND ASC)
);
...
(
    ID          SERIAL UNIQUE,
    CAR_INDEX   BIGINT UNSIGNED UNIQUE,
    PART_INDEX  BIGINT UNSIGNED UNIQUE,
    IMAGE_PATHS VARCHAR(1000) UNIQUE NOT NULL,
    PRIMARY KEY (ID),
    FOREIGN KEY (CAR_INDEX) REFERENCES PARTS_SHOP.CARS (CAR_INDEX) ON DELETE CASCADE ON UPDATE CASCADE,
