...
class FilterControllerUnitTest {
  ...
  @Test
  void shouldReturnNotEmptyModelAndView_whenOpenFilterPage_givenDefaultPagingParams()
      throws Exception {
  ...
  @Test
  void shouldReturnNotEmptyModelAndView_whenOpenFilterPage_givenBrandFromHomePage()
      throws Exception {
    searchParams.add("pageNumber", "0");
    searchParams.add("pageSize", "600");
